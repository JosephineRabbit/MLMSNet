...
class DSS(nn.Module):
    def __init__(self, base, feat_layers,e_feat_layers):
        ...
        self.up_e.append(nn.Conv2d(1,1,3,1,1))
        self.up_sal.append(nn.Conv2d(1, 1,3,1, 1))
        self.up_sal_e.append(nn.Conv2d(1, 1,3,1, 1))

        self.fuse_e = nn.Conv2d(5,1,3,1,1)
...
#            print(y2[i].shape,'========--------')
            ...
            m_1.append(self.up_sal[i](m1_y2[i]))
            m_2.append(self.up_sal[i](m2_y2[i]))
            #print(m[i].shape)
            m[i] = nn.Sigmoid()(m[i])
